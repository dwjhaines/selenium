...
#                                                                                             # 
# Tests that up to five managers can log in when the start date of teh license is in          #
# the future.                                                                                 #
#                                                                                             #
...
if __name__ == "__main__":
    ...
    print 'Max administrators allowed: %d' % maxManagers
    ...
    # Keep trying to log in each of the manager. Once the max number of users have been logged in, no further logins should be allowed.
    for user in users:
