...
#                                                                                             # 
# Tests that up to five managers can log in when the license has an invalid version           #
# number.                                                                                     #
#                                                                                             #
###############################################################################################
import time
...
class TestLicenseInvalidManagers(unittest.TestCase):
    def test_license_invalid_version_managers (self):
        ...
        users.append(um_utils.user('emergencyadmin', 'faelj*34#7k89@jkl'))    
